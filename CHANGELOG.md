...
Initial public release of **claude-dev-kit** — six domain-agnostic Claude Code plugins (ctk, dtk, atk, ftk, etk, cotk) sharing hook infrastructure via directory-level symlinks. MIT licensed.
