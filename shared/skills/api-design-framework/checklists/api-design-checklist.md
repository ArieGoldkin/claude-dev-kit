...
- [REST API Design Checklist](#rest-api-design-checklist)
...
- [GraphQL API Design Checklist](#graphql-api-design-checklist)
  - [Schema Design](#schema-design)
  - [Queries](#queries)
  - [Mutations](#mutations)
  - [Subscriptions](#subscriptions)
- [gRPC API Design Checklist](#grpc-api-design-checklist)
  - [Proto Files](#proto-files)
  - [Service Design](#service-design)
  - [Message Design](#message-design)
  - [Error Handling](#error-handling-1)
- [API Documentation Checklist](#api-documentation-checklist)
  - [OpenAPI/AsyncAPI Specification](#openapiasyncapi-specification)
...
- [Common API Anti-Patterns to Avoid](#common-api-anti-patterns-to-avoid)
