...
- [Test Steps](#test-steps)
  - [Given (Initial Context)](#given-initial-context)
  - [When (Action)](#when-action)
  - [Then (Expected Result)](#then-expected-result)
- [Detailed Test Steps (Alternative Format)](#detailed-test-steps-alternative-format)
- [Validation Checkpoints](#validation-checkpoints)
- [Test Code (Automated)](#test-code-automated)
- [Edge Cases and Variations](#edge-cases-and-variations)
