...
- [High-Level Review (Architecture & Design)](#high-level-review-architecture-design)
...
- [Database (if applicable)](#database-if-applicable)
...
- [ ] **Code Standards**: Meets standards in `.claude/skills/coding-standards/SKILL.md`
  - Functions < 50 lines, complexity < 10
  - Naming conventions followed (camelCase/snake_case/PascalCase)
