/**
 * DevOps Plugin - Hook System Entry Point
 *
 * This module provides the hook registry and exports all public APIs
 * for the TypeScript hook system. Registers the repo-access-guard hook.
 *
 * @module devops-hooks
 *
 * @example
 * ```typescript
 * import { registerHook, getHook, listHooks } from 'devops-hooks';
 *
...
import { repoAccessGuard } from './lifecycle/repo-access-guard.js';
registerHook(
