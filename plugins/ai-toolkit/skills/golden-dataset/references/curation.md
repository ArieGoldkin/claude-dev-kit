...
This reference provides patterns and workflows for **adding new documents** to the golden dataset with thorough quality analysis.
...
- Failing: <0.70 (off-topic for your domain)

---

## Multi-Agent Analysis Pipeline

See [multi-agent-pipeline.md](multi-agent-pipeline.md) for:
- Pipeline architecture diagram
- Agent specifications (Quality Evaluator, Difficulty Classifier, Domain Tagger, Query Generator)
- Consensus aggregation logic
- Langfuse integration and prompt management
