...
- [Agent Specifications](#agent-specifications)
  - [Quality Evaluator Agent](#quality-evaluator-agent)
  - [Difficulty Classifier Agent](#difficulty-classifier-agent)
  - [Domain Tagger Agent](#domain-tagger-agent)
  - [Query Generator Agent](#query-generator-agent)
- [Consensus Aggregation](#consensus-aggregation)
- [Langfuse Integration](#langfuse-integration)
  - [Prompt Management](#prompt-management)

Detailed agent specifications and consensus aggregation for curation.
...
def aggregate_results(
    ...
    if q["relevance"]["score"] < 0.7:
        warnings.append("Low relevance - may be off-topic for your domain")
