...
- [Regenerating Embeddings](#regenerating-embeddings)
- [SQL Dump (Alternative)](#sql-dump-alternative)
- [Error Handling](#error-handling)
- [References](#references)
- [Detailed Implementation (from SKILL.md)](#detailed-implementation-from-skillmd)
...
**Recommended: JSON (version controlled), SQL dump for local snapshots only.**
...
- Example: `data/golden_dataset_backup.json`

---

## Detailed Implementation (from SKILL.md)
...
### Restore: Regenerating Embeddings
