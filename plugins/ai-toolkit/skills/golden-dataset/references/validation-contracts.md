...
- [The URL Contract](#the-url-contract)
- [Data Integrity Checks](#data-integrity-checks)
- [Comprehensive Validation](#comprehensive-validation)
- [Pre-Deployment Checklist](#pre-deployment-checklist)
- [Automated Validation (CI)](#automated-validation-ci)
- [References](#references)
- [Detailed Validation Checklist (from SKILL.md)](#detailed-validation-checklist-from-skillmd)
...
analysis.url = "https://example.placeholder.com/placeholder/doc-123"
...
async def check_url_contract() -> list[str]:
    ...
    async with get_session() as session:
        query = select(Analysis).where(
            Analysis.url.like("%example.placeholder.com%") |
...
- Example: `scripts/backup_golden_dataset.py`
- Example: `tests/integration/test_retrieval_quality.py`

---

## Detailed Validation Checklist (from SKILL.md)
...
1. **Count validation** - Analyses, chunks, and artifacts match expected metadata
2. **URL contract** - No placeholder URLs in dataset
3. **Embedding completeness** - All chunks have generated embeddings
4. **Orphan detection** - No chunks without parent analyses
