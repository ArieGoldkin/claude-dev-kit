# Langfuse Traces - Implementation Example

## Table of Contents

- [Overview](#overview)
- [Trace Architecture](#trace-architecture)
- [Implementation Examples](#implementation-examples)
- [Real Metrics from Production](#real-metrics-from-production)
- [Dashboard Queries](#dashboard-queries)
- [Best Practices](#best-practices)
- [References](#references)


This document shows how to use Langfuse for end-to-end LLM observability across an 8-agent LangGraph workflow.
...
**File:** `app/workflows/content_analysis.py`
...
async def run_content_analysis(analysis_id: str, url: str) -> AnalysisResult:
    ...
    langfuse_context.update_current_trace(
        ...
        tags=["production", "analysis", "langgraph"]
    )
...
**File:** `app/workflows/nodes/agent_node.py`
...
**File:** `app/shared/services/llm/anthropic_client.py`
...
**File:** `app/workflows/nodes/quality_gate_node.py`
