...
- [Automated Scoring with G-Eval](#automated-scoring-with-g-eval)
- [Scores Dashboard](#scores-dashboard)
- [Quality Scores Trend Query](#quality-scores-trend-query)
- [Datasets for Evaluation](#datasets-for-evaluation)
- [Dataset Structure in UI](#dataset-structure-in-ui)
- [Evaluation Metrics](#evaluation-metrics)
- [Best Practices](#best-practices)
- [Integration with Quality Gate](#integration-with-quality-gate)
