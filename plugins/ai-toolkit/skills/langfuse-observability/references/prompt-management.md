...
- [Prompt Versioning in UI](#prompt-versioning-in-ui)
- [Prompt Templates with Variables](#prompt-templates-with-variables)
- [A/B Testing Prompts](#ab-testing-prompts)
- [Prompt Labels](#prompt-labels)
- [Best Practices](#best-practices)
- [4-Level Prompt Caching Architecture](#4-level-prompt-caching-architecture)
  - [L4 Jinja2 Template Fallback (Issue #414)](#l4-jinja2-template-fallback-issue-414)
  - [Variable Syntax Distinction](#variable-syntax-distinction)
- [Migration from Hardcoded Prompts (DEPRECATED)](#migration-from-hardcoded-prompts-deprecated)
...
## 4-Level Prompt Caching Architecture

A multi-level caching strategy with Jinja2 templates as L4 fallback:
...
When Langfuse is unavailable, the application falls back to Jinja2 templates:
...
**Template location:** `app/shared/services/prompts/templates/`
