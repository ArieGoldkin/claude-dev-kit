...
- [Basic Usage: @observe Decorator](#basic-usage-observe-decorator)
- [Result in Langfuse UI](#result-in-langfuse-ui)
- [Workflow Integration](#workflow-integration)
- [LangChain/LangGraph Integration with CallbackHandler](#langchainlanggraph-integration-with-callbackhandler)
