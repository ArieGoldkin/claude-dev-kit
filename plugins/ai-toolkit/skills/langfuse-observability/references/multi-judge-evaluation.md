...
- [Overview](#overview)
- [G-Eval Criteria](#g-eval-criteria)
- [Example Evaluators](#example-evaluators)
- [Wiring Evaluators to Workflow](#wiring-evaluators-to-workflow)
  - [Option 1: Quality Gate Integration](#option-1-quality-gate-integration)
  - [Option 2: Post-Workflow Evaluation](#option-2-post-workflow-evaluation)
- [Langfuse Experiments API](#langfuse-experiments-api)
- [Best Practices](#best-practices)
  - [1. Use Multiple Independent Judges](#1-use-multiple-independent-judges)
  - [2. Log All Scores to Langfuse](#2-log-all-scores-to-langfuse)
  - [3. Include Ground Truth When Available](#3-include-ground-truth-when-available)
  - [4. Track Judge Agreement](#4-track-judge-agreement)
- [Viewing Results in Langfuse](#viewing-results-in-langfuse)
...
The following example shows evaluators at `app/shared/services/g_eval/langfuse_evaluators.py`.
