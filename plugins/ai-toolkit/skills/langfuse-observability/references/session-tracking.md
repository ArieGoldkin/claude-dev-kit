...
- [Session View in UI](#session-view-in-ui)
- [User Tracking](#user-tracking)
- [Metadata Tracking](#metadata-tracking)
- [Analytics Queries](#analytics-queries)
  - [Performance by User](#performance-by-user)
  - [Performance by Content Type](#performance-by-content-type)
  - [Slowest Sessions](#slowest-sessions)
- [Tags for Filtering](#tags-for-filtering)
- [Best Practices](#best-practices)
- [Application Session Pattern](#application-session-pattern)
- [Identifying Slow or Expensive Users](#identifying-slow-or-expensive-users)
...
langfuse.trace(
    ...
    tags=["production", "analysis", "security"]
)
```
...
## Application Session Pattern

```python
# app/workflows/content_analysis.py
