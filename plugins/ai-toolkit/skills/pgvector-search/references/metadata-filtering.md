...
- [Overview](#overview)
- [Pre-Filtering (Before Search)](#pre-filtering-before-search)
- [Post-Filtering (After Search)](#post-filtering-after-search)
- [Score Boosting Strategies](#score-boosting-strategies)
  - [1. Section Title Matching (Acme)](#1-section-title-matching-acme)
  - [2. Document Path Matching (Acme)](#2-document-path-matching-acme)
  - [3. Content Type Boosting](#3-content-type-boosting)
  - [4. Recency Boosting](#4-recency-boosting)
- [Combined Boosting (Acme)](#combined-boosting-acme)
- [Faceted Search](#faceted-search)
- [Testing Boosting Strategies](#testing-boosting-strategies)
- [Common Pitfalls](#common-pitfalls)
  - [Pitfall 1: Over-Boosting](#pitfall-1-over-boosting)
  - [Pitfall 2: Boosting Before RRF](#pitfall-2-boosting-before-rrf)
  - [Pitfall 3: Missing Index on Filter Columns](#pitfall-3-missing-index-on-filter-columns)
...
- Acme: `backend/app/shared/services/search/search_service.py`
- Acme: `backend/app/core/constants.py` (boost factors)
