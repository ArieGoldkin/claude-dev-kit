...
- [The Solution: Reciprocal Rank Fusion](#the-solution-reciprocal-rank-fusion)
  - [RRF Algorithm](#rrf-algorithm)
  - [Why k=60?](#why-k60)
- [SQL Implementation](#sql-implementation)
- [Python Implementation (Acme)](#python-implementation-acme)
- [Fetch Multiplier Optimization](#fetch-multiplier-optimization)
- [Debugging RRF](#debugging-rrf)
- [Common Pitfalls](#common-pitfalls)
  - [Pitfall 1: Using Absolute Scores](#pitfall-1-using-absolute-scores)
  - [Pitfall 2: Insufficient Fetch Limit](#pitfall-2-insufficient-fetch-limit)
  - [Pitfall 3: Wrong Join Type](#pitfall-3-wrong-join-type)
- [References](#references)
- [RRF Score Function (Detailed)](#rrf-score-function-detailed)
...
- Acme: `backend/app/db/repositories/chunk_repository.py`

---

## RRF Score Function (Detailed)

Annotated single-document RRF scoring function, moved from the main skill file.
