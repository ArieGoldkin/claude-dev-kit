...
description: "Multi-agent fan-out/fan-in workflows — supervisor delegation, conflict resolution, and parallel research pipeline synthesis"
effort: low
paths:
  - "**/*agent*"
  - "**/*orchestrat*"
...
- `langgraph` (supervisor pattern) - LangGraph supervisor pattern
- `langgraph` (parallel execution) - Fan-out/fan-in with LangGraph
