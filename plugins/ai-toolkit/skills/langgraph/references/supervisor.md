...
- [Basic Supervisor](#basic-supervisor)
- [Round-Robin Supervisor](#round-robin-supervisor)
- [Priority-Based Routing](#priority-based-routing)
- [LLM-Based Supervisor (2026 Best Practice)](#llm-based-supervisor-2026-best-practice)
