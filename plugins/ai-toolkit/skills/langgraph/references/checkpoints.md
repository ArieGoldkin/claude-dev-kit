...
- [Checkpointer Options](#checkpointer-options)
- [Using Thread IDs](#using-thread-ids)
- [PostgreSQL Setup](#postgresql-setup)
- [Inspecting Checkpoints](#inspecting-checkpoints)
- [Resuming After Crash](#resuming-after-crash)
- [Step-by-Step Debugging](#step-by-step-debugging)
- [Store vs Checkpointer (2026 Best Practice)](#store-vs-checkpointer-2026-best-practice)
- [Using Store for Cross-Thread Memory](#using-store-for-cross-thread-memory)
