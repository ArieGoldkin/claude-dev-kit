...
- [TypedDict Approach (Simple)](#typeddict-approach-simple)
- [MessagesState Pattern (2026 Best Practice)](#messagesstate-pattern-2026-best-practice)
- [Pydantic Approach (Validation)](#pydantic-approach-validation)
- [Accumulating State Pattern](#accumulating-state-pattern)
