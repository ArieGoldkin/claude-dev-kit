...
- [2. Critical Questions Assessment](#2-critical-questions-assessment)
  - [Functional Questions](#functional-questions)
  - [Technical Questions](#technical-questions)
  - [Additional Critical Questions](#additional-critical-questions)
  - [Question Summary](#question-summary)
- [3. Dependency Check](#3-dependency-check)
  - [Task Dependencies](#task-dependencies)
  - [Technical Dependencies](#technical-dependencies)
  - [Dependency Summary](#dependency-summary)
- [4. Attempt History (if applicable)](#4-attempt-history-if-applicable)
- [5. Gate Decision](#5-gate-decision)
  - [Automatic Checks](#automatic-checks)
  - [Gate Status](#gate-status)
  - [Decision Rationale](#decision-rationale)
- [6. Actions Required](#6-actions-required)
- [7. Record in Context](#7-record-in-context)
