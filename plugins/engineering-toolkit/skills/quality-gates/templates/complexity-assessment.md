...
- [Assessment Criteria](#assessment-criteria)
  - [1. Lines of Code Estimate](#1-lines-of-code-estimate)
  - [2. Time Estimate](#2-time-estimate)
  - [3. Number of Files](#3-number-of-files)
  - [4. Dependencies Count](#4-dependencies-count)
  - [5. Unknowns/Uncertainty](#5-unknownsuncertainty)
  - [6. Cross-Cutting Concerns](#6-cross-cutting-concerns)
  - [7. Risk Level](#7-risk-level)
- [Total Complexity Score](#total-complexity-score)
  - [Complexity Level Assignment](#complexity-level-assignment)
- [Quick Complexity Guide](#quick-complexity-guide)
  - [Level 1: Trivial](#level-1-trivial)
  - [Level 2: Simple](#level-2-simple)
  - [Level 3: Moderate](#level-3-moderate)
  - [Level 4: Complex](#level-4-complex)
  - [Level 5: Very Complex](#level-5-very-complex)
- [Breakdown Requirement](#breakdown-requirement)
