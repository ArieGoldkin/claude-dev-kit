...
description: "Convert design prototypes (HTML, CSS, Figma) to production React + TypeScript. Extracts tokens and reusable patterns"
effort: medium
paths:
  - "**/*.html"
  - "**/*.css"
...
> See `${CLAUDE_SKILL_DIR}/templates/design-tokens-extract.json` for full template
...
> See `${CLAUDE_SKILL_DIR}/templates/component-base.tsx` and `${CLAUDE_SKILL_DIR}/templates/component-with-variants.tsx`
...
> See `${CLAUDE_SKILL_DIR}/references/conversion-patterns.md` for comprehensive HTML → React patterns
