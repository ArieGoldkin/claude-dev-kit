...
- [Attribute Conversions](#attribute-conversions)
  - [Basic Attributes](#basic-attributes)
  - [Event Handlers](#event-handlers)
  - [Boolean Attributes](#boolean-attributes)
- [Style Conversions](#style-conversions)
  - [Inline Styles to Objects](#inline-styles-to-objects)
  - [Inline Styles to Tailwind](#inline-styles-to-tailwind)
  - [Common Style Mappings](#common-style-mappings)
- [Form Elements](#form-elements)
  - [Uncontrolled to Controlled Input](#uncontrolled-to-controlled-input)
  - [Select Element](#select-element)
  - [Checkbox](#checkbox)
  - [Form Submission](#form-submission)
- [Interactive Elements](#interactive-elements)
  - [Clickable Div to Button](#clickable-div-to-button)
  - [Link Button](#link-button)
  - [Modal/Dialog](#modaldialog)
- [Lists and Iteration](#lists-and-iteration)
  - [Static List to Dynamic](#static-list-to-dynamic)
  - [With Unique IDs (Preferred)](#with-unique-ids-preferred)
...
- [Accessibility Additions](#accessibility-additions)
