...
- [Layout](#layout)
- [Control types for code maps](#control-types-for-code-maps)
- [Canvas rendering](#canvas-rendering)
- [Connection types and styling](#connection-types-and-styling)
- [Comment system](#comment-system)
- [Prompt output for code maps](#prompt-output-for-code-maps)
- [Pre-populating with real data](#pre-populating-with-real-data)
- [Layer color palette (light theme)](#layer-color-palette-light-theme)
