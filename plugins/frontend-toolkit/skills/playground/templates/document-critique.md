...
- [Key components](#key-components)
  - [Document panel (left)](#document-panel-left)
  - [Suggestions panel (right)](#suggestions-panel-right)
  - [Prompt output (bottom)](#prompt-output-bottom)
- [State structure](#state-structure)
- [Suggestion matching to lines](#suggestion-matching-to-lines)
- [Document rendering](#document-rendering)
- [Prompt output generation](#prompt-output-generation)
- [Styling highlights](#styling-highlights)
- [Pre-populating suggestions](#pre-populating-suggestions)
