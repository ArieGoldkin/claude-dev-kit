...
- [Form-Based Login](#form-based-login)
  ...
  - [Multi-Step Login (Email then Password)](#multi-step-login-email-then-password)
  - [Handle Login Errors](#handle-login-errors)
- [OAuth/SSO Flows](#oauthsso-flows)
- [Session Management](#session-management)
  - [Save and Restore State](#save-and-restore-state)
  - [Check Login State](#check-login-state)
  - [Handle Session Expiry](#handle-session-expiry)
- [Persist Across Captures](#persist-across-captures)
- [Security Considerations](#security-considerations)
  - [Never Store Credentials in Code](#never-store-credentials-in-code)
  - [Secure State Files](#secure-state-files)
  - [Handle Sensitive Sites with Headed Mode](#handle-sensitive-sites-with-headed-mode)
- [Common Sites](#common-sites)
  - [GitHub Private Repos](#github-private-repos)
  - [Confluence/Jira (SSO)](#confluencejira-sso)
  - [Notion](#notion)
