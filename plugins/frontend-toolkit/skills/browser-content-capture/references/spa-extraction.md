...
- [Why SPAs Are Different](#why-spas-are-different)
- [Detection Patterns](#detection-patterns)
  - [Identify SPA Framework](#identify-spa-framework)
- [React Extraction](#react-extraction)
  - [Wait for React Hydration](#wait-for-react-hydration)
  - [Next.js Specific](#nextjs-specific)
  - [Docusaurus Sites](#docusaurus-sites)
- [Vue Extraction](#vue-extraction)
  - [Wait for Vue Mount](#wait-for-vue-mount)
  - [Nuxt Specific](#nuxt-specific)
  - [VitePress/VuePress](#vitepressvuepress)
- [Angular Extraction](#angular-extraction)
  - [Wait for Angular Bootstrap](#wait-for-angular-bootstrap)
- [Generic SPA Patterns](#generic-spa-patterns)
  - [Wait for Content, Not Framework](#wait-for-content-not-framework)
  - [Handle Infinite Scroll](#handle-infinite-scroll)
  - [Handle Lazy Images](#handle-lazy-images)
  - [Extract Clean Content](#extract-clean-content)
