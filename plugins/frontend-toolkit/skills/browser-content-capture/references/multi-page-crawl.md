...
- [Overview](#overview)
- [Basic Crawl Pattern](#basic-crawl-pattern)
  - [Extract Links, Then Visit](#extract-links-then-visit)
- [Structured Crawl with Metadata](#structured-crawl-with-metadata)
- [Pagination Handling](#pagination-handling)
  - [Click-Based Pagination](#click-based-pagination)
  - [URL-Based Pagination](#url-based-pagination)
- [Recursive Crawl](#recursive-crawl)
  - [Follow All Links (Depth-Limited)](#follow-all-links-depth-limited)
- [Parallel Crawling with Sessions](#parallel-crawling-with-sessions)
- [Best Practices](#best-practices)
  - [1. Rate Limiting](#1-rate-limiting)
  - [2. Error Handling](#2-error-handling)
  - [3. Resume Capability](#3-resume-capability)
  - [4. Respect robots.txt](#4-respect-robotstxt)
